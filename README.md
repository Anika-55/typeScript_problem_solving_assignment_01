...
* অবজেক্টের shape বর্ণনা করে

* কোনো ফাংশনালিটি বাস্তবায়ন করে না

* টাইপ-চেকিং এবং স্ট্রাকচারের দিকে মনোযোগ
...
* স্ট্যাটিক টাইপ চেকিং সম্ভব করে
* runtime-এ error ধরার আগে catch করতে সাহায্য করে
